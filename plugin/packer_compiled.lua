...
_G.packer_plugins = {
  ...
  everforest = {
    loaded = true,
    path = "/home/me/.local/share/nvim/site/pack/packer/start/everforest",
  ...
  ["neodev.nvim"] = {
    loaded = true,
    path = "/home/me/.local/share/nvim/site/pack/packer/start/neodev.nvim",
  ...
  vim = {
    loaded = true,
    path = "/home/me/.local/share/nvim/site/pack/packer/start/vim",
